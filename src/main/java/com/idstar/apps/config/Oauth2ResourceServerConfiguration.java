package com.idstar.apps.config;
...
//    private static final String SECURED_PATTERN = "/api/**";
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatcher("/**")
                .authorizeRequests()
                    .antMatchers("/" //hilangin
                            ,"/showFile/**","/v1/showFile/**","/v1/upload", "/user-register/**","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/user-login/**",
                            "/forget-password/**", "/oauth/authorize**", "/login**", "/error**",
                            "/v1/barang/**")
                    .permitAll()
                .antMatchers("/v1/role-test-global/list-barang").hasAnyAuthority("ROLE_READ")
                .antMatchers("/v1/role-test-global/post-barang").hasAnyAuthority("ROLE_WRITE","ROLE_READ")
