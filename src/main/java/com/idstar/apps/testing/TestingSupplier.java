...
//        HttpEntity<String> entity = new HttpEntity<String>(request, headers);
        Long idSupplier = 1L;
        String url = "http://localhost:9091/api/v1/idstar/supplier/" + idSupplier;
...
//        assertEquals(HttpStatus.OK, exchange.getStatusCode());
    ...
    public void insertSupplier() {
        ...
        ResponseEntity<String> exchange = restTemplate.exchange("http://localhost:9091/api/v1/idstar/supplier/save", HttpMethod.POST, entity, String.class);
